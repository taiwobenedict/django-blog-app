...
class Post(models.Model):
  owner = models.ForeignKey(User, on_delete= models.CASCADE, null= True, blank= True, related_name='post')
  image = models.ImageField(default='kindpng_4517876.png', blank= True)
...
class Profile(models.Model):
  ...
  profile_picture = models.ImageField(default ='kindpng_4517876.png', blank= True)
  cover_picture = models.ImageField(default='kindpng_4517876.png', blank= True)
  ...
  def save(self, *args, **kwargs):
    if (self.profile_picture == None) or (self.profile_picture == ''):
